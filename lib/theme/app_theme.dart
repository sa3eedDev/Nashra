...
class AppTheme {
  // Colors from the provided theme - primary palette
  ...
  // Surface colors - darker variants for the new theme
  ...
  static TextStyle scoreTextStyle = GoogleFonts.notoSansArabic(
    textStyle: const TextStyle(
      color: primaryA0,
      fontSize: 50,
